...
const schema = yup
  .object({
    file: yup
      .mixed<File>()
      .required()
      .test((file) => file instanceof File && file.type === "application/json")
      .label("File"),
...
export default function BatchImport() {
  ...
  /** Import All */
  const importAll = async (file: File, pinCode: string): Promise<void> => {
  ...
  const mutation = useMutation({
    ...
    mutationFn: async (data: { file: File; pinCode: string }) => {
